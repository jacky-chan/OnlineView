<%@ page language="C#" autoeventwireup="true" inherits="Demo.UI.MachineCode.Class_UI_M, App_Web_c22efipp" %>
            ...
            <div id="nav-strip">
                <ul>
                    <li class="nav-item no-subnav " id="nav-item_1"><a href="#"><span class="primary-link">
                        框架Demo</span></a></li>
                    <li class="nav-item no-subnav active" id="nav-item_2"><a href="Class_M.aspx"><span
        ...
        <div id="content" class="p_5 clearfix">
                        ...
                        <div class="bg_main">
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb_style02 validationGroup">
                                <tr>
                                    ...
                                    <td>
                                        <asp:TextBox ID='txbM_ClassID' runat='server' onkeyup='javascript:clearNoNum(this);' CssClass='input_style1 IntegerNum' />
                                    </td>
                                    <th>
                                        名字：
                                    </th>
            ...
            <div class="searchModule clearfix">
                ...
                <div class="bg_left">
                    <div class="bg_right">
                        <div class="bg_main">
                            <asp:GridView ID="gvData" runat="server" DataKeyNames=" cniClassID" CssClass="tb_style01"
                                Width="100%" AllowPaging="True" PagerSettings-Visible="false" OnRowCommand="gvData_RowCommand"
                                AutoGenerateColumns="False">
                                <Columns>
                                    <asp:BoundField HeaderText='cniClassID' DataField='cniClassID' />
