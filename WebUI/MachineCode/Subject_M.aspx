<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Subject_M.aspx.cs" Inherits="Demo.UI.MachineCode.Subject_UI_M" %>
            ...
            <div id="nav-strip">
                <ul>
                    ...
                    <li class="nav-item no-subnav " id="nav-item_3"><a href="Student_M.aspx"><span class="primary-link">
                        学员管理</span></a></li>
                    <li class="nav-item no-subnav active" id="nav-item_4"><a href="Subject_M.aspx"><span
                        class="primary-link">科目管理</span></a></li>
                </ul>
            </div>
        </div>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb_style02 validationGroup">
                                    <tr>
                                        <tr>
                                            <th>Name：</th>
                                            <td>
                                                <asp:TextBox ID='txbM_Name' runat='server' CssClass='input_style1' /></td>
                                            <th>Score：</th>
                                            <td>
                                                <asp:TextBox ID='txbM_Score' runat='server' onkeyup='javascript:clearNoNum(this);'
                                                    CssClass='input_style1' /></td>
                                        </tr>
                                        <tr>
                                            <th>&nbsp; </th>
                                            <td>
                        ...
                        <div class="bg_right">
                            <div class="bg_main">
                                <asp:GridView ID="gvData" runat="server" DataKeyNames=" cnuID" CssClass="tb_style01"
                                    ...
                                    <Columns>
                                        <asp:BoundField HeaderText='Name' DataField='cnvcName' />
                                        <asp:BoundField HeaderText='Score' DataField='cnfScore' />
                    ...
                    <div class="bg_left">
                        <div class="bg_right">
                            <div class="bg_main">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb_style02 validationGroup">
                                    <tr>
                                        <asp:TextBox ID='txbNewM_cnuID' runat='server' Visible='False' /><th>Name：</th>
                                        <td>
                                            <asp:TextBox ID='txbNewM_Name' runat='server' CssClass='input_style1 ' />
                                        </td>
                                        <th>Score：</th>
                                        <td>
                                            <asp:TextBox ID='txbNewM_Score' onkeyup='javascript:clearNoNum(this);' runat='server'
                                                CssClass='input_style1 ' /></td>
                                    </tr>
                                    <%--     <tr>
                      <th>cniID：</th>
