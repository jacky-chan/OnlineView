<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Student_M.aspx.cs" Inherits="Demo.UI.MachineCode.Student_UI_M" %>
                                ...
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb_style02 validationGroup">
                                    <tr>
                                        <tr>
                                            ...
                                            <td>
                                                <asp:TextBox ID='txbM_ClassID' runat='server' onkeyup='javascript:clearNoNum(this);'
                                                    CssClass='input_style1 IntegerNum' /></td>
                                            <th>SID1：</th>
                                            <td>
                                                <asp:TextBox ID='txbM_SID' runat='server' CssClass='input_style1' /></td>
                                            <th>密码：</th>
                                            <td>
                                                <asp:TextBox ID='txbM_Password' runat='server' CssClass='input_style1' /></td>
                                        </tr>
                                        <tr>
                                            <th>名字：</th>
                                            <td>
                                        ...
                                        <tr>
                                            <th>邮箱：</th>
                                            <td>
                                                <asp:TextBox ID='txbM_Email' runat='server' CssClass='input_style1' /></td>
                                            <th>是否管理员：</th>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <th colspan="2" style="text-align: center">
                                                <asp:Button ID="btnSearch" CssClass="btn_style02 causesValidation" runat="server" Text="查 询"
                    ...
                    <div class="bg_left">
                        <div class="bg_right">
                            <div class="bg_main">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb_style02 validationGroup">
                                    <tr>
                                        <asp:TextBox ID='txbNewM_ID' runat='server' Visible='False' /><th><em>* </em>CLASSI：
                                        </th>
                                        <td>
                                            <asp:TextBox ID='txbNewM_ClassID' onkeyup='javascript:clearNoNum(this);' runat='server'
                                                CssClass='input_style1 IntegerNum required ' /></td>
                                        <th><em>* </em>SID1：</th>
                                        <td>
