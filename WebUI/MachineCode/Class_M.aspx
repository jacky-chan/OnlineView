<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Class_M.aspx.cs" Inherits="Demo.UI.MachineCode.Class_UI_M" %>
                    ...
                    <div class="bg_left">
                        <div class="bg_right">
                            <div class="bg_main">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0" class="tb_style02 validationGroup">
                                    <tr>
                                        <asp:TextBox ID='txbNewM_ClassID' runat='server' Visible='False' /><th>名字：</th>
                                        <td>
